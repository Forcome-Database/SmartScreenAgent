...
| 3 | WP3 Durable asynchronous ingestion and batch processing | In progress | WP2 | [`2026-07-20-wp3-durable-async-ingestion.md`](2026-07-20-wp3-durable-async-ingestion.md) |
