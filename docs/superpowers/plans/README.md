...
| 6 | WP6 Review, golden set, and rule simulation | In progress (WP6a) | WP4 and WP5 | WP6a: approved [specification](../specs/2026-07-22-wp6a-feedback-capture-design.md) and [implementation plan](2026-07-22-wp6a-feedback-capture.md); WP6b/WP6c not yet planned |
